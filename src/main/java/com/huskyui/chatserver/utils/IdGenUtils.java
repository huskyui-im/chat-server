...
public class IdGenUtils {
    private static SnowFlakeGenerateIdWorker snowFlakeGenerateIdWorker;

    static {
        snowFlakeGenerateIdWorker = new SnowFlakeGenerateIdWorker(1,1);
    }

    public static String id(){
        return snowFlakeGenerateIdWorker.generateNextId();
    }




    public static class SnowFlakeGenerateIdWorker {
